...
const socketIo = (io) => {
    ...
    // Create middlewares to prevent client without token to access socket
    io.use((socket, next) => {
    ...
    io.on('connection', async (socket) => {
        ...
        // Define listener on event load message
        socket.on('load messages', async (payload) => {
            ...
            try {
                ...
                const verifed = jwt.verify(token, tokenKey)

                // Catch recipient id sent from client
                const idRecipient = payload
                const idSender = verifed.id // id user
        ...
        socket.on('send message', async (payload) => {
            try {
                ...
                // Catch recipient id and message sent from client
